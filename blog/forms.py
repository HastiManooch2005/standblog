...
class ConcatForm(forms.Form):
    ...
    birthday = forms.DateField(widget=forms.SelectDateWidget(years=year_choises, attrs={'class': 'form-control'}))
    text = forms.CharField(label='text)')

    def clean_text(self):  # brary field khas shart bezarim bade clean esm field migozarim
...
class MessageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'text': forms.TextInput(attrs={'class': 'form-control','placeholder': 'Enter your message'})
        }